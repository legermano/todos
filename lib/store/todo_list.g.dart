...
mixin _$TodoList on _TodoList, Store {
  ...
  ObservableList<Todo> get completedTodos => (_$completedTodosComputed ??=
      ...
      .value;
  Computed<bool> _$hasComplitedTodosComputed;

  @override
  bool get hasComplitedTodos => (_$hasComplitedTodosComputed ??=
          Computed<bool>(() => super.hasComplitedTodos))
      .value;
